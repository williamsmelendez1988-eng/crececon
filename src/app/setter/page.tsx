      ...
      <main className="panel-main" style={{ marginLeft: 240, flex: 1, padding: '32px', minHeight: '100vh' }}>
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <p style={{ fontFamily: 'DM Sans,sans-serif', color: 'rgba(255,255,255,0.38)', fontSize: '0.875rem', margin: '4px 0 0' }}>
            Tu progreso y resultados de hoy
          </p>
        </div>
        ...
        <div style={{ background: 'linear-gradient(135deg,rgba(26,58,143,0.15),rgba(34,197,94,0.08))', border: '1px solid rgba(96,165,250,0.2)', borderRadius: 20, padding: '28px', marginBottom: 24, position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 20, position: 'relative' }}>
            ...
            <div style={{ textAlign: 'right' }}>
              <div style={{ fontFamily: 'Syne,sans-serif', fontWeight: 800, fontSize: '2.2rem', background: 'linear-gradient(135deg,#60A5FA,#22C55E)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', lineHeight: 1 }}>
                {loading ? '—' : puntos}
              </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: 16, marginBottom: 32 }}>
          {[
            ...
            <div key={stat.label} style={{ background: 'rgba(13,20,38,0.7)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 16, padding: '20px' }}>
              ...
              <div style={{ fontFamily: 'Syne,sans-serif', fontWeight: 800, fontSize: '1.8rem', color: stat.color, lineHeight: 1, marginBottom: 6 }}>
                {loading ? '—' : stat.value}
              </div>
